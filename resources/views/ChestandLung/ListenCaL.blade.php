                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane " id="v-pills-two" role="tabpanel"
                                    ...
                                    <img src="/result/ผลตรวจปอด ฟัง 2.jpg" class="img-fluid" alt="...">
                                </div>
                                <div class="tab-pane " id="v-pills-three" role="tabpanel"
                                    aria-labelledby="v-pills-three-tab" tabindex="0">

                                    <img src="/result/ผลตรวจปอด ฟัง 3.jpg" class="img-fluid" alt="...">

                                </div>
                                <div class="tab-pane " id="v-pills-four" role="tabpanel"
